...
const journey: RouteStop[] = [
  {
    ...
    organization: 'INTERNSHALA (SCHOLIVERSE EDUCARE PVT. LTD.)',
    description: 'Selected as a campus ambassador to guide and motivate students toward skill development and career opportunities. Promoted educational initiatives, technical training campaigns, and internship drives across campus communities.',
  },
  {
    id: '02',
    year: 'JUN - JUL 2026',
    title: 'NETWORK TRAFFIC ANALYSIS PROJECT',
    organization: 'UNITED GROUP OF INSTITUTIONS • SUMMER TRAINING',
    description: 'Architected and managed a virtualized security testing environment using Kali Linux and Windows. Studied port scanning, SYN flooding, and brute-force testing, and inspected network telemetry in Wireshark to identify anomaly signatures.',
  },
  {
    id: '03',
    year: 'MAR 2026',
    title: 'COLLEGE SMART ISSUE REPORTING SYSTEM',
    organization: 'U-HACK 4.0 • TEAM CODEX CREATORS',
    description: 'Collaborated in a cross-functional team to develop an automated campus issue reporting system during a 24-hour innovation hackathon. Designed system architecture and prepared technical pitch decks for expert evaluation.',
  },
  {
    id: '04',
    year: 'EXPECTED 2029',
    title: 'B.TECH IN CSE (AI & ML)',
    organization: 'UNITED COLLEGE OF ENGINEERING AND RESEARCH (UCER)',
    description: 'Pursuing a Bachelor of Technology in Computer Science & Engineering with a specialization in Artificial Intelligence & Machine Learning.',
  },
  {
    id: '05',
    year: 'TRAINING & CERTIFICATIONS',
    title: 'CONTINUOUS LEARNING',
    organization: 'HARVARD • UGI • UNIATHENA',
    description: 'Completed CS50x: Introduction to Computer Science, Summer Training in Network Traffic Analysis & Cyber Attack Detection, and Executive Certification in Artificial Intelligence.',
  },
];
