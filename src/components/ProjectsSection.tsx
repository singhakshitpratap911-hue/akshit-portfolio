...
const projects: Project[] = [
  {
    ...
    description: 'A security testing and traffic analysis project using a virtualized Kali Linux and Windows environment. Explored port scanning, SYN flooding, and brute-force testing, then inspected packet telemetry in Wireshark to study anomaly signatures and false positives.',
    ...
    metrics: [
      ...
      { label: 'ANALYSIS', value: 'Deep Packet Inspection' },
      { label: 'FOCUS', value: 'Anomaly Signatures' },
    ],
  },
  {
    number: '02',
    title: 'College Smart Issue Reporting System',
    category: 'HACKATHON / CAMPUS AUTOMATION',
    description: 'An automated campus issue reporting concept developed during U-HACK 4.0, a 24-hour innovation hackathon. The work included collaborative solution development, system architecture, and technical pitch preparation.',
    githubUrl: 'https://github.com/singhakshitpratap911-hue',
    tech: ['System Architecture', 'Rapid Prototyping', 'Technical Pitching', 'Team Collaboration'],
    metrics: [
      { label: 'EVENT', value: 'U-HACK 4.0' },
      { label: 'DURATION', value: '24-Hour Hackathon' },
      { label: 'TEAM', value: 'CODEX CREATORS' },
    ],
  },
];
