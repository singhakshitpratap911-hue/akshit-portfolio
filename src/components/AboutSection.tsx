        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Akshit Pratap Singh</span>, a Computer Science & Engineering undergraduate specializing in Artificial Intelligence & Machine Learning. I build practical software, explore network security, and develop solutions for hackathon environments using Python, C, packet telemetry, and security analysis.
            </motion.p>
