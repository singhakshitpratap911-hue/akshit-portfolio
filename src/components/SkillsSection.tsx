...
const bentoCategories = [
  {
    ...
    badge: 'CORE SKILLS',
    items: ['C', 'Python', 'Linux (Kali)', 'Windows'],
    description: 'Building practical software solutions with a foundation in programming, operating systems, and technical problem solving.',
    stat: 'C + PYTHON',
  ...
  },
  {
    ...
    badge: 'SECURITY',
    items: ['Wireshark', 'Nmap', 'Hping3', 'Hydra'],
    description: 'Analyzing packet telemetry, inspecting network traffic, and studying security testing techniques in controlled environments.',
    stat: 'PACKET ANALYSIS',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'AI & MACHINE LEARNING',
    badge: 'SPECIALIZATION',
    items: ['Artificial Intelligence', 'Machine Learning', 'Threat Analysis'],
    description: 'Exploring AI and machine learning concepts while applying analytical thinking to security and software projects.',
    stat: 'AI / ML',
    colSpan: 'lg:col-span-5',
  },
  {
    title: 'PROJECT & TEAM DELIVERY',
    badge: 'EXECUTION',
    items: ['Rapid Prototyping', 'Technical Pitching', 'Leadership', 'Hackathons'],
    description: 'Turning problem statements into working prototypes, architecture plans, and clear technical presentations under time constraints.',
    stat: 'HACKATHON READY',
    colSpan: 'lg:col-span-7',
  },
];
